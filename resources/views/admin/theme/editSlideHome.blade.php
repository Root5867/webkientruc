...
<section class="content">
		...
		<form method="post" enctype="multipart/form-data" class="row">
			...
			<div class="form-group col-md-6">
				...
				<input type="number" name="number" class="form-control" value="{{$slidehome->number}}" required="" min="1" maxlength="8">
			</div>
			<div class="form-group col-md-6">
				<label for="image">Ảnh bìa</label>
				<img src="{{asset('public/img/slideHome/'.$slidehome->image)}}" alt="" width="50%">
				<input type="file" name="image" class="form-control" >
				<input type="hidden" name="image" value="{{$slidehome->image}}">
			</div>
			<!-- ckeditor & ckfinder -->
			...
			<div class="form-group col-md-12">
				...
				<textarea name="caption" id="caption"  class="form-control" >{{$slidehome->caption}}</textarea>
